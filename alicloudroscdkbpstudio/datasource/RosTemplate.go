...
// This class is a base encapsulation around the ROS resource type `DATASOURCE::BPStudio::Template`.
type RosTemplate interface {
	...
	AttrTopoUrl() alicloudroscdkcore.IResolvable
...
func (j *jsiiProxy_RosTemplate) AttrCreateTime() alicloudroscdkcore.IResolvable {
...
func (j *jsiiProxy_RosTemplate) AttrImageUrl() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrImageUrl",
...
func (j *jsiiProxy_RosTemplate) AttrResourceGroupId() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrResourceGroupId",
...
func (j *jsiiProxy_RosTemplate) AttrTopoUrl() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrTopoUrl",
...
func (j *jsiiProxy_RosTemplate) RefreshOptions() interface{} {
...
func (j *jsiiProxy_RosTemplate) TemplateId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"templateId",
...
func NewRosTemplate(scope alicloudroscdkcore.Construct, id *string, props *RosTemplateProps, enableResourcePropertyConstraint *bool) RosTemplate {
	...
	_jsii_.Create(
		"@alicloud/ros-cdk-bpstudio.datasource.RosTemplate",
...
func (j *jsiiProxy_RosTemplate)SetRefreshOptions(val interface{}) {
...
func (j *jsiiProxy_RosTemplate)SetTemplateId(val interface{}) {
