...
func (r *jsiiProxy_RosTransitRouterVpcAttachment) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosTransitRouterVpcAttachment) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosTransitRouterVpcAttachment) FetchRosDependency() *[]*string {
	var returns *[]*string
