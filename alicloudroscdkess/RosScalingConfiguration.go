...
func (r *jsiiProxy_RosScalingConfiguration) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosScalingConfiguration) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosScalingConfiguration) FetchRosDependency() *[]*string {
	var returns *[]*string
