...
// This class encapsulates and extends the ROS resource type `ALIYUN::Flink::Instance`Creates a subscription or pay-as-you-go Realtime Compute for Apache Flink instance.
