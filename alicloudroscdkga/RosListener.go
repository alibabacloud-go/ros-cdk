...
type RosListener interface {
	...
	SetClientAffinity(val interface{})
	...
	SetProxyProtocol(val interface{})
...
func (j *jsiiProxy_RosListener) AcceleratorId() interface{} {
...
func (j *jsiiProxy_RosListener) ClientAffinity() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"clientAffinity",
...
func (j *jsiiProxy_RosListener) Name() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_RosListener) PortRanges() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"portRanges",
...
func (j *jsiiProxy_RosListener) ProxyProtocol() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"proxyProtocol",
...
func (j *jsiiProxy_RosListener)SetAcceleratorId(val interface{}) {
...
func (j *jsiiProxy_RosListener)SetClientAffinity(val interface{}) {
...
func (j *jsiiProxy_RosListener)SetPortRanges(val interface{}) {
...
func (j *jsiiProxy_RosListener)SetProxyProtocol(val interface{}) {
