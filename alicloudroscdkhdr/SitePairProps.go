...
type SitePairProps struct {
	...
	//
	// This parameter is valid only when the site pair
	// type is cross-zone disaster recovery.
	...
	//
	// This parameter is valid only when the site
	// pair type is cross-zone disaster recovery.
