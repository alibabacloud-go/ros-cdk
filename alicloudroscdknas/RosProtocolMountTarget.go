...
func (r *jsiiProxy_RosProtocolMountTarget) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosProtocolMountTarget) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosProtocolMountTarget) FetchRosDependency() *[]*string {
	var returns *[]*string
